...
import { LayoutDashboard, FileText, Target, Activity, Settings, User, LogOut, ChevronDown, PenTool, Globe, Cloud, ListChecks, BookOpen, CreditCard, Zap, Network, Bell, FolderUp, Database, HardDrive, Bot, BrainCircuit } from "lucide-react";
      ...
      <main className="flex-1 ml-72 flex flex-col min-h-screen relative overflow-x-hidden text-white selection:bg-indigo-500/30">
         ...
         <header className="sticky top-0 h-20 bg-[#020617]/60 backdrop-blur-xl border-b border-white/5 z-40 px-8 flex items-center justify-between shadow-2xl">
            ...
            <div className="flex items-center gap-5">
               ...
               <Link href="/account/usage" className="flex items-center gap-2 bg-gradient-to-r from-orange-500/10 to-pink-500/10 border border-orange-500/20 px-4 py-1.5 rounded-full hover:bg-orange-500/20 transition-all group">
