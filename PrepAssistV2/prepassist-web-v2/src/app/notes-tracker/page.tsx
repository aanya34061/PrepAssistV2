...
import { ArrowLeft, Bell, BellRing, FileText, Camera, Globe, UploadCloud, Plus, File, Search, Loader2, BookOpen, X, XCircle, Star, StarOff, Trash2, ListFilter, EyeOff } from "lucide-react";
       ...
       <div className="max-w-4xl mx-auto px-6 pt-12">
          ...
          {!activeSubject ? (
             ...
             <motion.div key="grid" initial={{opacity:0, y:10}} animate={{opacity:1, y:0}} exit={{opacity:0, y:-10}}>
                ...
                <div className="mb-10 bg-[#FDF4ED] border border-[#F97316]/20 p-5 rounded-2xl flex flex-col md:flex-row items-start md:items-center gap-5 shadow-sm relative overflow-hidden">
