...
import { BrainCircuit, PenTool, Globe, ChevronRight, Target, Cloud, Database, Lock, Sparkles, Activity, ShieldCheck, Network, CheckCircle2 } from "lucide-react";
      ...
      <nav className="fixed w-full z-50 top-0 border-b border-slate-200/60 bg-white/80 backdrop-blur-3xl transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
             ...
             <Link href="/login?mode=register" className="px-5 py-2.5 rounded-full bg-slate-900 text-white hover:bg-slate-800 font-bold text-sm transition-all flex items-center gap-2 shadow-md hover:shadow-lg">
